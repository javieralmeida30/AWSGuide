...
const serviceAssociations = [
    ...
    { icon: '🏗️', term: 'Infraestructura como código, plantillas de despliegue', service: 'AWS CloudFormation - Modelado y provisión de recursos de AWS mediante plantillas.' },
    ...
    { icon: '🗃️', term: 'Archivado de datos por mucho tiempo o para backups', service: 'Amazon Glacier - Almacenamiento de archivos de bajo costo para archivos y backups a largo plazo.' },
    ...
    { icon: '🚀', term: 'CD Despliegue continuo', service: 'AWS CodeDeploy - Automatización de despliegue de aplicaciones a cualquier instancia.' },
    { icon: '🔄', term: 'CI Construcción continua', service: 'AWS CodeBuild - Servicio de construcción continua totalmente administrado.' },
    { icon: '💬', term: 'Interacción conversacional con Machine Learning', service: 'Amazon Lex - Construcción de interfaces de conversación en cualquier aplicación.' },
    ...
    { icon: '🛠️', term: 'Gestión de infraestructura, Chef y Puppet.', service: 'AWS OpsWorks - Herramientas de gestión de configuración para Chef y Puppet.' },
    { icon: '🗂️', term: 'Puerta de enlace (gateway) de almacenamiento', service: 'AWS Storage Gateway - Conexión de aplicaciones on-premises a almacenamiento en la nube.' },
