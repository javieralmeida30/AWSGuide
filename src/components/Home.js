    ...
    return (
        <div>
            ...
            <div className="home-content">
                ...
                <p>Esta guía está diseñada para ayudarte a prepararte para los exámenes de AWS Cloud Practitioner y AWS Solutions Architect Associate. Usa la barra de navegación para explorar diferentes secciones incluyendo documentación, exámenes interactivos y consejos.</p>
                <div className="section-buttons">
                    <Link to="/documentation" className="button">
                        <h3>Documentación</h3>
                        <p>Encuentra información detallada sobre los servicios de AWS necesarios para los exámenes.</p>
                    </Link>
