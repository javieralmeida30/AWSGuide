...
function Documentation() {
    ...
    return (
        <section id="documentation">
            <h2>Documentación</h2>
            <p>En esta sección encontrarás información detallada sobre los servicios y conceptos de AWS que son relevantes para los exámenes de certificación Cloud Practitioner y Solutions Architect Associate. Selecciona el nivel de certificación y explora los servicios disponibles en cada categoría.</p>
            <div className="tabs">
                <button onClick={() => handleLevelClick('CP')}>Servicios Cloud Practitioner</button>
                <button onClick={() => handleLevelClick('SAA')}>Servicios SAA</button>
            </div>
