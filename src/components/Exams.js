...
function Exams() {
        ...
        "CP1": [
            {
                ...
                answer: "C",
                explanation: "Nube Híbrida -> Correcto. Esta es una combinación de nubes públicas y privadas unidas por tecnología que permite compartir datos y aplicaciones entre ellas. La empresa puede aprovechar los recursos compartidos en la nube pública y mantener los datos sensibles en la nube privada."
            },
            {
                ...
                answer: "C",
                explanation: "Dar a los usuarios los permisos mínimos necesarios para completar sus tareas. -> Correcto. El principio de privilegio mínimo sugiere dar a los usuarios solo los permisos mínimos que necesitan para realizar sus tareas. Esto minimiza el impacto potencial de una cuenta comprometida."
            },
            {
                ...
                answer: "B",
                explanation: "AWS Artifact -> Correcto. AWS Artifact es un servicio de AWS que proporciona acceso bajo demanda a los informes de cumplimiento de AWS. Estos informes pueden ayudar a entender cómo los servicios de AWS se alinean con los requisitos de GDPR."
            },
            {
                ...
                answer: "A",
                explanation: "Amazon S3 -> Correcto. Amazon S3 (Simple Storage Service) es un servicio de almacenamiento de objetos que ofrece escalabilidad, disponibilidad de datos, seguridad y rendimiento líderes en la industria. S3 es ideal para análisis de big data porque puede almacenar y recuperar cualquier cantidad de datos en cualquier momento desde cualquier lugar."
            },
            {
                ...
                answer: "A",
                explanation: "AWS VPN -> Correcto. AWS VPN establece una conexión segura y privada desde una red local o un cliente a AWS. Es la mejor opción para asegurar la privacidad de los datos y proporcionar conexiones seguras para usuarios individuales desde múltiples ubicaciones."
            },
            {
                ...
                answer: "C",
                explanation: "Colocar los servidores web en una subred pública y los servidores de bases de datos en una subred privada. -> Correcto. Los servidores web en una subred pública son accesibles desde Internet. Los servidores de bases de datos en una subred privada no son accesibles desde Internet, proporcionando la seguridad requerida."
            },
            {
            ...
            },
            {
                ...
                answer: "B",
                explanation: "No generar claves de acceso para cuentas raíz. -> Correcto. AWS recomienda no generar claves de acceso para cuentas raíz. En su lugar, cree usuarios de IAM, otórgueles los permisos necesarios y use sus claves de acceso."
            },
            {
                ...
                answer: "D",
                explanation: "Implementar un grupo de Auto Scaling. -> Correcto. Los grupos de Auto Scaling pueden aumentar o disminuir el número de instancias de EC2 en respuesta a la demanda, lo que los convierte en una solución ideal para garantizar la capacidad de respuesta durante los picos de tráfico y la rentabilidad durante los períodos de menor actividad."
            },
            {
                ...
                answer: "C",
                explanation: "Implementar la aplicación en múltiples zonas de disponibilidad dentro de una sola región. -> Correcto. Implementar la aplicación en múltiples zonas de disponibilidad dentro de una sola región es la estrategia correcta. Asegura que, incluso si una zona de disponibilidad falla, la aplicación permanezca disponible en las otras zonas de disponibilidad."
            },
            {
                ...
                answer: "C",
                explanation: "AWS WAF (Web Application Firewall) -> Correcto. AWS WAF le permite escribir reglas para coincidir con patrones de actividad maliciosa, como bloquear tráfico de direcciones IP específicas."
            },
            {
                ...
                answer: "A",
                explanation: "Instancias On-Demand de Amazon EC2 -> Correcto. Las instancias On-Demand de Amazon EC2 son las menos rentables en este escenario. Tienen un costo por hora más alto en comparación con otras opciones como las instancias Spot o las instancias Reservadas."
            },
            {
                ...
                answer: "C",
                explanation: "Permite aumentar o disminuir la capacidad de almacenamiento según la demanda. -> Correcto. La elasticidad es el beneficio que le permite escalar rápidamente los recursos hacia arriba y hacia abajo para satisfacer la demanda."
            },
            {
                ...
                answer: "A",
                explanation: "Adjuntar la política administrada AmazonS3ReadOnlyAccess al rol de IAM. -> Correcto. La política administrada AmazonS3ReadOnlyAccess otorga acceso de solo lectura a todos los buckets y objetos de S3, cumpliendo con el requisito para la función Lambda."
            },
            {
                ...
                answer: "D",
                explanation: "AWS CloudTrail -> Correcto. AWS CloudTrail registra, monitorea continuamente y conserva la actividad de la cuenta relacionada con acciones en su infraestructura de AWS, incluyendo el registro de llamadas a la API."
            },
            {
                ...
                answer: "A",
                explanation: "Precios On-Demand -> Correcto. El precio On-Demand es la respuesta correcta. Ofrece un modelo de pago por uso donde paga por la capacidad de cómputo por hora o por segundo dependiendo de lo que use. Esto proporciona flexibilidad y sin compromiso a largo plazo, lo que lo hace ideal para cargas de trabajo impredecibles."
            },
            {
                ...
                answer: "D",
                explanation: "Regiones -> Correcto. Las regiones son áreas geográficas separadas. AWS tiene regiones en todo el mundo y los datos no salen de la región a menos que se muevan explícitamente. Esto ayuda a cumplir con los requisitos de residencia de datos, cumplimiento y soberanía, lo que lo convierte en la respuesta correcta."
            },
            {
                ...
                answer: "A",
                explanation: "Amazon EC2 -> Correcto. Amazon EC2 proporciona capacidad de cómputo redimensionable en la nube y permite el control total sobre el sistema operativo, el runtime y la pila de red, lo que permite modificaciones personalizadas del kernel. Es el más adecuado para aplicaciones que requieren tales niveles de control."
            },
            {
                ...
                answer: "B",
                explanation: "Instancias Spot de EC2 -> Correcto. Las instancias Spot de EC2 son la respuesta correcta. Le permiten ofertar por capacidad de cómputo no utilizada de Amazon EC2 y son ideales para tareas de procesamiento que pueden ser interrumpidas, lo que las convierte en una solución rentable para cómputos grandes y de corta duración."
            },
            {
            ...
            },
            {
                ...
                answer: "A",
                explanation: "El cliente debe habilitar manualmente el cifrado para cada bucket de S3 -> Correcto. El cliente debe habilitar manualmente el cifrado para cada bucket de S3. Esto se puede hacer a nivel de bucket o a nivel de objeto."
            },
            {
            ...
            },
            {
                ...
                answer: "D",
                explanation: "Amazon S3 con replicación entre regiones habilitada -> Correcto. Amazon S3 con replicación entre regiones habilitada es la respuesta correcta. Esta configuración replica automáticamente los datos entre múltiples regiones de AWS, asegurando la durabilidad de los datos incluso si una región completa no está disponible."
            },
            {
                ...
                answer: "A",
                explanation: "Hacer cumplir MFA en el usuario de IAM a través de una política de IAM administrada. -> Correcto. Se puede hacer cumplir MFA en los usuarios de IAM utilizando una política de IAM administrada. Esta política luego se puede adjuntar al usuario de IAM para hacer cumplir MFA."
            },
            {
                ...
                answer: "A",
                explanation: "Amazon EC2 y AWS Auto Scaling -> Correcto. Amazon EC2 proporciona los recursos de cómputo, y AWS Auto Scaling ajusta automáticamente el número de instancias de EC2 en función de la demanda, lo que los convierte en la respuesta correcta."
            },
            {
                question: "Está trabajando con una empresa que tiene una arquitectura de aplicación web de tres niveles en una VPC. La arquitectura incluye una capa web, una capa de aplicación y una capa de base de datos. Cada capa está en una subred separada. ¿Cuál de los siguientes enfoques debería tomar para garantizar el mayor nivel de seguridad? Seleccione todas las que correspondan.",
                options: [
                    "A. Aplicar un grupo de seguridad a la capa web para permitir el tráfico entrante en el puerto 80 desde 0.0.0.0/0.",
                    "B. Aplicar un solo grupo de seguridad a las tres capas para simplificar la gestión.",
                    "C. Aplicar un grupo de seguridad a la capa de aplicación para permitir el tráfico entrante en el puerto necesario solo desde el grupo de seguridad de la capa web.",
                    "D. Aplicar un grupo de seguridad a la capa de base de datos para permitir el tráfico entrante solo desde el grupo de seguridad de la capa de aplicación.",
                    "E. Aplicar grupos de seguridad que permitan todo el tráfico dentro de la VPC."
                ],
                answer: "A,C,D",
                explanation: "Aplicar un grupo de seguridad a la capa web para permitir el tráfico entrante en el puerto 80 desde 0.0.0.0/0. -> Correcto. Esto es correcto y necesario para permitir que los usuarios accedan a la aplicación web desde Internet.\nAplicar un grupo de seguridad a la capa de aplicación para permitir el tráfico entrante en el puerto necesario solo desde el grupo de seguridad de la capa web. -> Correcto. Esto también es correcto y garantiza que solo la capa web pueda interactuar con la capa de aplicación.\nAplicar un grupo de seguridad a la capa de base de datos para permitir el tráfico entrante solo desde el grupo de seguridad de la capa de aplicación. -> Correcto. La base de datos debe ser accesible solo desde la capa de aplicación, proporcionando un nivel adicional de seguridad."
            },
            {
                ...
                answer: "D",
                explanation: "Instancias Spot de Amazon EC2 -> Correcto. Las instancias Spot de Amazon EC2 le permiten aprovechar la capacidad no utilizada de EC2 en la nube de AWS. Las instancias Spot están disponibles con descuentos de hasta el 90% en comparación con los precios On-Demand y podrían ser la opción más rentable para cargas de trabajo no sensibles al tiempo."
            },
            {
                ...
                answer: "D",
                explanation: "Parchar el sistema operativo invitado de sus instancias EC2. -> Correcto. El cliente es responsable de parchear el sistema operativo invitado y las aplicaciones que ejecutan en sus instancias EC2."
            },
            {
                ...
                answer: "B",
                explanation: "Crear una política de IAM personalizada y asignarla al grupo. -> Correcto. Las políticas de IAM personalizadas son el método preferido cuando se necesita un control preciso. Aquí, se puede crear una política de IAM personalizada para otorgar el acceso de lectura requerido en buckets específicos de S3 y luego asignarla al grupo."
            },
            {
                ...
                answer: "C",
                explanation: "Crear una política personalizada que permita las acciones ec2:StartInstances y ec2:StopInstances y adjuntarla al grupo. -> Correcto. Crear una política personalizada que específicamente permita las acciones ec2:StartInstances y ec2:StopInstances cumple con el requisito sin otorgar permisos innecesarios."
            },
            {
                ...
                answer: "C",
                explanation: "AWS proporciona un informe de prueba de eliminación de datos para cada trabajo de Snowball. -> Correcto. AWS proporciona un informe de prueba de eliminación de datos, que sirve como prueba de que el dispositivo Snowball ya no contiene los datos importados después de que se complete la tarea. Esto lo convierte en la respuesta correcta."
            },
            {
                ...
                answer: "B",
                explanation: "AWS Secrets Manager -> Correcto. AWS Secrets Manager está diseñado específicamente para almacenar, gestionar y recuperar secretos de forma segura. Ayuda a proteger el acceso a sus aplicaciones, servicios y recursos de TI, sin los costos iniciales y de mantenimiento continuo de operar su propia infraestructura."
            },
            {
                ...
                answer: "A",
                explanation: "Costo de la electricidad para alimentar y enfriar los centros de datos -> Correcto. Al moverse a la nube de AWS, ya no tiene que alimentar y enfriar sus propios centros de datos, lo que puede resultar en ahorros de costos significativos. Por lo tanto, esta es la respuesta correcta."
            },
            {
                ...
                answer: "A",
                explanation: "AWS KMS -> Correcto. AWS Key Management Service (KMS) es un servicio gestionado que facilita la creación y el control de las claves de cifrado utilizadas para cifrar datos, y utiliza módulos de seguridad de hardware (HSM) para proteger la seguridad de las claves."
            },
            {
                ...
                answer: "B",
                explanation: "Tomar instantáneas regulares del volumen de Amazon EBS -> Correcto. Tomar instantáneas regulares del volumen de Amazon EBS crea copias de seguridad puntuales de sus volúmenes en Amazon S3, que se pueden usar para habilitar la recuperación ante desastres, migrar datos entre regiones o cuentas, mejorar el cumplimiento de copias de seguridad o crear grandes entornos de prueba."
            },
            {
                ...
                answer: "B",
                explanation: "Ubicaciones Edge -> Correcto. Las Ubicaciones Edge son la respuesta correcta. Son sitios desplegados en las principales ciudades del mundo que almacenan contenido en caché para una entrega de menor latencia a los usuarios."
            },
            {
                ...
                answer: "A",
                explanation: "Usar Amazon RDS con MySQL. -> Correcto. Amazon RDS con MySQL es un servicio gestionado que se encarga de las tareas administrativas de bases de datos, como copias de seguridad, parcheo y conmutación por error, y proporciona alta disponibilidad con una implementación Multi-AZ."
            },
            {
                ...
                answer: "B",
                explanation: "Utilizar Amazon CloudFront para almacenar en caché el contenido de la aplicación más cerca de los usuarios. -> Correcto. Amazon CloudFront es una red de entrega de contenido (CDN) que almacena copias de su contenido en ubicaciones edge en todo el mundo. Esto acercaría el contenido de la aplicación a los usuarios, reduciendo la latencia."
            },
            {
                ...
                answer: "D",
                explanation: "Crear un rol de IAM con los permisos necesarios y asociarlo con una instancia de EC2 que ejecute la aplicación. -> Correcto. Un rol de IAM proporciona credenciales de seguridad temporales que la aplicación puede usar para hacer solicitudes a la API de AWS. Asociar este rol con la instancia de EC2 permite que la aplicación que se ejecuta en esa instancia asuma el rol."
            },
            {
                ...
                answer: "D",
                explanation: "Usar AWS Organizations para aislar el entorno de producción a nivel de cuenta. -> Correcto. AWS Organizations ayuda a gestionar y gobernar centralmente sus entornos en múltiples cuentas de AWS. Aislar entornos utilizando diferentes cuentas de AWS previene cambios accidentales y agrega una capa adicional de seguridad."
            },
            {
                ...
                answer: "D",
                explanation: "Escribir una función personalizada de AWS Lambda que verifique la antigüedad de las claves de acceso en todas las cuentas y las rote si tienen más de 60 días. -> Correcto. AWS Lambda le permite ejecutar código sin aprovisionar ni gestionar servidores. Puede escribir una función que verifique y rote las claves de acceso, luego invocar esta función en múltiples cuentas."
            },
            {
                ...
                answer: "D",
                explanation: "Proporcionar una auditoría detallada de todas las acciones y eventos pasados de IAM. -> Correcto. AWS Trusted Advisor proporciona alertas proactivas y orientación sobre las mejores prácticas, pero no proporciona una auditoría detallada de todas las acciones y eventos pasados de IAM. Esto sería el rol de AWS CloudTrail."
            },
            {
                ...
                answer: "C",
                explanation: "AWS Cost Explorer -> Correcto. AWS Cost Explorer proporciona información detallada sobre los costos y el uso de AWS, lo que permite un análisis detallado y la identificación de áreas para reducir costos."
            },
            {
                ...
                answer: "A",
                explanation: "Aplicar una política de grupo de IAM administrada -> Correcto. Las políticas de grupo de IAM administradas pueden usarse para exigir que los usuarios usen MFA para iniciar sesión."
            },
            {
                ...
                answer: "C",
                explanation: "Grupos de Seguridad -> Correcto. Los Grupos de Seguridad actúan como un firewall virtual para sus instancias, controlando el tráfico de entrada y salida."
            },
            {
                ...
                answer: "A",
                explanation: "Amazon S3 con replicación entre regiones habilitada -> Correcto. La replicación entre regiones de Amazon S3 permite la replicación automática de datos en múltiples regiones de AWS."
            },
            {
                ...
                answer: "B",
                explanation: "AWS Lambda y Amazon DynamoDB -> Correcto. AWS Lambda permite ejecutar código sin aprovisionar servidores, y Amazon DynamoDB es una base de datos NoSQL totalmente gestionada que puede escalar automáticamente."
            },
            {
                ...
                answer: "B",
                explanation: "AWS CloudTrail -> Correcto. AWS CloudTrail proporciona un registro detallado de las acciones realizadas por los usuarios, roles y servicios de AWS, permitiendo auditorías de seguridad y análisis de problemas."
            },
            {
                ...
                options: [
                    "A. S3 Standard",
                    "B. S3 Standard-IA (Acceso poco frecuente)",
                    "C. S3 One Zone-IA",
                    "D. S3 Glacier"
                ],
                answer: "B",
                explanation: "S3 Standard-IA (Acceso poco frecuente) -> Correcto. S3 Standard-IA es ideal para datos a los que se accede con poca frecuencia pero que necesitan ser recuperados rápidamente cuando se soliciten."
            },
            {
                ...
                answer: "B",
                explanation: "Usar AWS KMS para el cifrado del lado del servidor -> Correcto. AWS Key Management Service (KMS) proporciona una forma segura y gestionada de cifrar datos en Amazon S3 utilizando claves gestionadas por AWS."
            },
            {
                ...
                answer: "B",
                explanation: "AWS VPN -> Correcto. AWS VPN proporciona una conexión segura y privada desde una red local o un cliente a AWS, adecuada para conexiones seguras desde múltiples ubicaciones."
            },
            {
                ...
                answer: "B",
                explanation: "Amazon EC2 Auto Scaling -> Correcto. Amazon EC2 Auto Scaling ajusta automáticamente el número de instancias de EC2 en función de la demanda, proporcionando escalabilidad automática."
            },
            {
                ...
                answer: "C",
                explanation: "Amazon DynamoDB -> Correcto. Amazon DynamoDB es una base de datos NoSQL completamente gestionada que puede escalar automáticamente en función de la carga de trabajo."
            },
            {
                ...
                answer: "C",
                explanation: "Configurar una política de contraseña en IAM -> Correcto. IAM permite configurar una política de contraseña que puede exigir la rotación de contraseñas cada 90 días."
            },
            {
                ...
                answer: "B",
                explanation: "AWS SDK para Python (Boto3) -> Correcto. Boto3 es el SDK de AWS para Python, diseñado para ayudar a los desarrolladores a escribir software que use servicios como Amazon S3, Amazon EC2, entre otros."
            },
            {
                ...
                answer: "C",
                explanation: "Amazon DynamoDB con modo de capacidad On-Demand -> Correcto. Amazon DynamoDB con modo de capacidad On-Demand puede manejar cargas de trabajo impredecibles y picos de tráfico, proporcionando tiempos de respuesta de un solo dígito en milisegundos."
            },
            {
                ...
                answer: "D",
                explanation: "Recomendaciones para optimizar el rendimiento de las consultas de su base de datos on-premises. -> Correcto. AWS Trusted Advisor se centra en los servicios de AWS, por lo que no puede proporcionar recomendaciones para bases de datos on-premises."
            },
            {
                ...
                answer: "C",
                explanation: "En AWS, puede automatizar la escala de recursos según la demanda, reduciendo la necesidad de intervención manual. -> Correcto. La principal ventaja de la elasticidad de AWS es la capacidad de escalar automáticamente los recursos hacia arriba y hacia abajo según la demanda, reduciendo la necesidad de intervención manual y mejorando la utilización de recursos."
            },
            {
                ...
                answer: "A",
                explanation: "Adjuntar las políticas administradas AmazonRDSFullAccess y IAMReadOnlyAccess al grupo. -> Correcto. AmazonRDSFullAccess proporciona acceso completo a los recursos de Amazon RDS, e IAMReadOnlyAccess permite a los usuarios ver pero no modificar los recursos de IAM."
            }
        ]
    };
    ...
    const calculateScore = useCallback(() => {
        ...
        selectedExam.forEach((question, index) => {
            ...
            explanations.push({
                ...
                selected: selectedOption ? `${selectedOption}. ${question.options.find(opt => opt.startsWith(selectedOption))}` : 'No respondida',
                correctAnswer: `${correctOption}. ${question.options.find(opt => opt.startsWith(correctOption))}`
            });
        });
    ...
    return (
        <section id="exams">
            <h2>AWS CLOUD PRACTITIONER EXAMEN</h2>
